...
<% 
    Integer noCols = (Integer) session.getAttribute("no_cols");
    String formName = (String) session.getAttribute("form_name");
    if (noCols != null && formName != null) {
%>
 
<%
    } else {
%>
    <p>Session attributes not found. Please go back and try again.</p>
<%
    }
	int cols = (int)noCols;
%>
    ...
    <div class="container">
        <h3>  Add Form Details for <%= formName %> by Drag  Input Box to the Appropriate Field</h3>
       Add Form Details for <%= formName %>
