...
@WebServlet("/EmpProgressWkflServlet")
public class EmpProgressWkflServlet extends HttpServlet {
    ...
    private JSONArray fetchTableData(Connection conn, String tableName, int curId) {
        ...
        try {
            ...
            String query = 
                "SELECT t.*,wa.current_state FROM " + tableName + " t join workflow_action wa on t.cur_id = wa.cur_id  WHERE t.cur_id = ?  ";
